...
const Floor = () => {
    const { control, setValue, getValues, watch } = useFormContext<HouseFormData>();
            ...
            <motion.div {...slideInRight}>
                <div className='flex flex-col items-center justify-between text-center'>
                    <FormField
                        ...
                        render={({ field }) => {
                            return (
                                <InputWrapper isError={false} label='what is the floor count?'>
                                    <InputSlider
                                        name='floorCount'
                                        min={1}
                                        max={5}
                        ...
                        >
                            ...
                            <CardContent>
                                <FormField
                                    ...
                                    render={({ field }) => {
                                        return (
                                            <InputWrapper isError={false} label='What is the room count?'>
                                                <InputSlider
                                        ...
                                        <Card key={room.id} className='mb-4 bg-gray-300'>
                                            ...
                                            <CardContent>
                                                <FormField
                                                    ...
                                                    render={({ field }) => {
                                                        return (
                                                            <InputWrapper
                                                                isError={false}
                                                                label='What is the room size in square meters?'
                                                            >
                                                                <InputSlider
                                                ...
                                                <FormField
                                                    ...
                                                    render={({ field }) => {
                                                        return (
                                                            <InputWrapper isError={false} label='how many windows?'>
                                                                <InputSlider
                                                ...
                                                {room.windows.map((window, windowIndex) => {
                                                    return (
                                                        <div key={window.id} className='flex flex-col md:flex-row'>
                                                            <FormField
                                                                control={control}
